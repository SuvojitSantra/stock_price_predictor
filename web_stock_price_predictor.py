...
#model = load_model("Latest_stock_price_model.keras  D:\stock price predictor\Latest_stock_price_model.keras ")
model = load_model(r"D:\stock price predictor\Latest_stock_price_model.keras")
...
st.subheader('Original Close Price and and MA for 100 days MA for 250 days')
...
st.subheader("Orginal Values VS Predicted Values")
st.write(ploting_data)


st.subheader('Original Close Price VS Predicted Close Price')
fig = plt.figure(figsize=(15,6))
plt.plot(pd.concat([google_data.Close[:spliting_len+100],ploting_data], axis=0))
...
# streamlit run "d:\stock price predictor\web_stock_price_predictor.py"
